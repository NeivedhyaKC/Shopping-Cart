...
const MainLayout = (props) =>
{
    ...
    return (
        <div>
            <Cart CloseCart={CloseCart} productsInCart={props.productsInCart} setProductsInCart={props.setProductsInCart}/>
            ...
            <li>
                <button id="cartDiv" onClick={OpenCart}>
                {
                    props.productsInCart.length === 0 ? null : <p id="cartNotification">{ props.productsInCart.length}</p>
                }
